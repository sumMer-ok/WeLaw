...
提供Markdown格式的笔记编辑功能，功能参照飞书云文档标准，需支持文本格式化、图片插入、表格编辑等核心功能。
...
| 引用 | > | 引用块 |
| 代码 | ``` | 代码块，支持语法高亮 |
| 表格 | /table | 数据表格，支持行列操作 |
| 图片 | /image | 插入图片，支持拖拽上传 |
| 案例链接 | /case | 链接到案例库中的案例 |
| 词汇卡片 | /vocab | 插入词汇卡片 |
| 思维导图 | /mindmap | 嵌入思维导图 |
| 分割线 | --- | 水平分割线 |
| 折叠列表 | >! | 可折叠内容 |
...
│  • 被告构成根本违约                                          │
│  • 支持原告的损害赔偿请求                                    │
│  • 适用Hadley v. Baxendale规则                              │
│                                                             │
│  📎 相关案例:                                               │
│  [Hadley v. Baxendale] [Victoria Laundry v. Newman]        │
│                                                             │
│  ```                                                       │
│  损害赔偿 = 预期利益 - 实际损失                              │
│  ```                                                       │
